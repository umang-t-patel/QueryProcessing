...
'''
This is the Demo 3 of the Project.
Demo 3 - Voice to Query which includes simple Queries with no feedback and all variations
...
def index(request):
	...
	if request.method == 'POST':
		...
		test = []
		ret_dict={'test':test}
		return render(request,'demo3.html',context=ret_dict)
