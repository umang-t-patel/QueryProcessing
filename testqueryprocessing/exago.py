...
def performNLP(google_output):
    ...
    # print('Not Noun:',result_text_not_noun)
    # print('Noun:',result_text_noun)
...
def performsimilarity(input_list, data_list):
    ...
    for input_word in input_list:
        for data_word in data_list:
            ...
            if wordFrominput_list and wordFromdata_list: #Thanks to @alexis' note
...
def getresults(text):
    ...
    # send_data = {"DisplayField": "Employees_0.City","AggMethod": 6}
    # temp_data = [{"EntityName": "Employees_0", "ColumnName": "LastName", "Operator": 0, "Values": [ "King", "null" ]}]
    # # temp_data = [{"EntityName": "Employees_0","ColumnName": "LastName","Operator": 0,"Values": [ "Davolio", "null" ]},
    # # {"EntityName": "Products_0","ColumnName": "ProductName","Operator": 0,"Values": [ "Tofu", "null" ]},
    # # {"EntityName": "Orders_0","ColumnName": "OrderDate","Operator": 12,"Values": [ "2014-01-01 00:00:00.000", "2014-12-31 00:00:00.000"]}]
    # send_data["Filters"] = temp_data
    # print(getdata(send_data)["ExecuteData"])
